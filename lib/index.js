...
var sortByTabIndex = function sortByTabIndex(current, sibling) {
  // current, sibling
  /* String or null */
  var currentValue = current.getAttribute('tabindex');
  var siblingValue = sibling.getAttribute('tabindex');

  var c = void 0,
      s = void 0;

  /* Only positive integers or NaN */
  var currentIndex = !!(c = toNumber(currentValue)) ? c : NaN;
  var siblingIndex = !!(s = toNumber(siblingValue)) ? s : NaN;
...
var Pentonville = function (_Component) {
  ...
  function Pentonville() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref7 = Pentonville.__proto__ || Object.getPrototypeOf(Pentonville)).call.apply(_ref7, [this].concat(args))), _this), _this.setPentonville = function (pentonville) {
